...
//
final public class MethodHelper
{
    public static void
    insert(org.omg.CORBA.Any any, Method val)
    {
    ...
    type()
    {
        if(typeCode_ == null)
        {
            ...
            typeCode_ = orb.create_interface_tc(id(), "Method");
        }
    ...
    id()
    {
        return "IDL:alfresco/corba_wrappers/Method:1.0";
    }
    ...
    public static void
    write(org.omg.CORBA.portable.OutputStream out, Method val)
    {
    ...
    narrow(org.omg.CORBA.Object obj)
    {
        if(obj != null)
        {
            ...
            if(obj._is_a(id()))
            {
                ...
                StubForMethod stub = new StubForMethod();
