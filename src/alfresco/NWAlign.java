/*
 * $Revision: 1.1 $
 * $Id: NWAlign.java,v 1.1 2003/04/04 10:14:42 niclas Exp $
 *
...
package alfresco;
/**
 * Class implementing the Needleman-Wunsch alignment algortithm
 * @version 1
 * @author Niclas Jareborg, The Sanger Centre
 */
public class NWAlign extends Align {
	
	/**
	 * Creates a NWAlign, and aligns the to specified features
	 * @param feature1 first feature
	 * @param feature2 second feature
	 */
	public NWAlign(SeqFeature feature1, SeqFeature feature2) {
...
// 		NWAlign al = new NWAlign(ex1, ex2);
// 		System.out.print("\t\t");
