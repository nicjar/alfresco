/*
* $Revision: 1.1 $
* $Id: BlEst_Genome.java,v 1.1 2003/04/04 10:13:46 niclas Exp $
 *
...
/**
 * BlEst_Genome uses and parses results from est_genome 
 * @version 1
 * @author Niclas Jareborg, The Sanger Centre
 */

public class BlEst_Genome extends Thread{
...
// 	Vector result;
  ...
  static String[] executables = { "blEst_genome" };
  static String d = "rna";
  static String h = "5";
  static String e = "1e-30";
 ...
 */
 	public BlEst_Genome(Entry ent, Properties props) {
		entry = ent;
// 		result = new Vector();
 ...
 */
 	public BlEst_Genome(FastaFile gFile, Properties props) {
// 		result = new Vector();
    gSeqFile = gFile;
//     eSeqFile = eFile;
    properties = props;
...
// 		String eg = SystemConstants.EST_GENOMEPATH + "est_genome -reverse -est " + eSeqFile.getPath() + " -genome " + gSeqFile.getPath();
		String eg = properties.getProperty("blEst_genome") 
